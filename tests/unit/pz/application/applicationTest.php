...
final class ApplicationTest extends TestCase
{
    ...
    public static function validPageSignaturesProvider(): array
    {
        ...
        return [
            ['index', DummyController::class, null, '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, 'good_method', '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, 'bad_method', '../tests/unit/pz/test_ressources', 'index.php', 'index.latte'],
            ['index', null, [[DummyController::class, 'good_method']], '../tests/unit/pz/test_ressources', null, 'index.latte', Privacy::PUBLIC],
            ['index', null, [[DummyController::class, 'good_method'], [DummyController::class, 'bad_method']], '../tests/unit/pz/test_ressources', 'index.php', 'index.latte', Privacy::PUBLIC],
            ['index', null, ["GET" => [DummyController::class, 'good_method'], "POST" => [DummyController::class, 'bad_method']], '../tests/unit/pz/test_ressources', null, 'index.latte', Privacy::PUBLIC],
            ['index', null, ["GET" => [DummyController::class, 'good_method'], "POST" => [[DummyController::class, 'bad_method'], [DummyController::class, 'good_method']]], '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, ["GET" => ['good_method'], "POST" => ['bad_method', 'good_method']], '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, ['good_method', ['bad_method', 'good_method']], '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, ['good_method', 'bad_method'], '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, ['good_method', 'bad_method', 'good_method'], '../tests/unit/pz/test_ressources'],
            ['index', DummyController::class, [['good_method'], ['bad_method', 'good_method']], '../tests/unit/pz/test_ressources'],
        ];
    }
    ...
    public function testPagesAddition(): void
    {
        ...
        $default_module->page('index', DummyController::class, folder: '../tests/unit/pz/test_ressources');
    ...
    public function testCannotAddPageWithUnknownTemplate(): void
    {
        ...
        $this->expectException(\Exception::class);
        $default_module->page('unknown_page', template: 'unknown_template.latte', folder: '../tests/unit/pz/test_ressources');
    }
