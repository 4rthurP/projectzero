...
$default->view('install.php', 'install.latte', Method::GET, Privacy::PUBLIC);
...
$admin->action('admin/initialize_database', AdminController::class, 'initialize_database', Method::POST, Privacy::LOGGED_IN);
